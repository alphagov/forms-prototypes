  ...
  for (var i in input) {
    ...
    if (Array.isArray(val)) {
      ...
      if (i == "pages") {
        ...
        var filteredPages = data.pages.filter((page) => parseInt(page.pageIndex) !== parseInt(editedPage.pageIndex));

        // Add new page object to array and sort by page index
        data.pages = [...filteredPages, editedPage].sort((a, b) => parseInt(a.pageIndex) - parseInt(b.pageIndex));
