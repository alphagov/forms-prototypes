...
module.exports = {
  ...
  selectionMultipleOptionsHintHint: 'Use hint text to help people answer the question. For a question where people can select more than one answer you might want to use ‘Select all that apply’.',

  numberQuestionHint: 'Ask the question the way you would in person. For example, ‘How many holiday days do you get a year?’',
  numberHintHint: 'Use hint text to help people answer the question. For example, ‘Do not include bank holidays’.',
